...
# Stałe role
VIEWER_ROLE_ID = 1396940699798081621  # dostęp tylko, bez pisania
WRITER_ROLE_ID = 1396940700112781448  # dostęp i pisanie
...
TICKET_TYPES = {
	"ranga": {
		...
		"handler_roles": [],  # pingowane
		"viewer_roles": [1396940700112781448], # tylko dostęp
		"fields": [
	...
	"pozew": {
		...
		"handler_roles": [1396940700087619763],
		"viewer_roles": [1396940700112781447],
		"fields": [
			("Imię i nazwisko (IC)", "np. John Doe", True),
			("Numer SSN", "np. 54175", True),
	...
	"prawo": {
		"label": "Pomoc Prawna",
		"handler_roles": [1396940700087619761],
		"viewer_roles": [1396940700087619760],
		"fields": [
			("Imię i nazwisko (IC)", "np. John Doe", True),
			("Numer SSN", "np. 54175", True),
			("Data urodzenia", "np. 20-02-1997", True),
	...
	"zarzad": {
		...
		"handler_roles": [],
		"viewer_roles": [1396940700112781448],
		"fields": [
			("Imię i nazwisko (IC)", "np. John Doe", True),
	...
	"skarga": {
		...
		"handler_roles": [1396940700087619762],
		"viewer_roles": [1396940700112781446, 1396940700112781445, 1396940700112781447],
		"fields": [
			("Imię i nazwisko (IC)", "np. John Doe", True),
			("Numer SSN", "np. 54175", True),
	...
	"inne": {
		"label": "Inna sprawa",
		"handler_roles": [],
		"viewer_roles": [1396940700087619757],
			"fields": [
				("Imię i nazwisko (IC)", "np. John Doe", True),
